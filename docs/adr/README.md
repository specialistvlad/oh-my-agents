...
| [0004](0004-task-tracker-domain-model.md)              | The task tracker is one generic item type with a runtime schema                   |
...
| [0008](0008-realtime-communication-over-websockets.md) | Clients talk over one bidirectional WebSocket, scoped by rooms                    |
